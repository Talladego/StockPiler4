...
<ModuleFile xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
    <UiMod name="StockPiler4" version="0.4.35" date="2026-09-25">
        ...
        <Files>
            ...
            <File name="Source/Knowledge/WatchReserves.lua" />
            ...
            <File name="Source/Planner/SkillUpGates.lua" />
            <File name="Source/Planner/CultSkillPlan.lua" />
